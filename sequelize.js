...
sequelize.sync().then(async ()=>{
    ...
    if (eventUserCount == 0) {
        await EventUser.bulkCreate([
            {  eventId: 1, userId: 1 },  // Ana participă la Conferinta Tech
            {  eventId: 1, userId: 2 },  // Mihai participă la Conferinta Tech
            {  eventId: 1, userId: 3 },  // Elena participă la Conferinta Tech
            {  eventId: 2, userId: 1 },  // Ana participă la Workshop AI
            {  eventId: 2, userId: 3 },  // Elena participă la Workshop AI
            {  eventId: 3, userId: 2 },  // Mihai participă la Hackathon Winter
            {  eventId: 3, userId: 3 }   // Elena participă la Hackathon Winter
        ]);
    }
})
